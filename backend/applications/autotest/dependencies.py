...
from backend.applications.autotest.services.autotest_case_transfer_crud import AutoTestCaseTransferCrud
...
from backend.applications.autotest.services.autotest_task_crud import AutoTestTaskCrud
