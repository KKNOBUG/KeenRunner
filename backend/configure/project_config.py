...
class ProjectConfig(BaseSettings):
    ...
    APP_DESCRIPTION1: str = """
    KeenRunner 测管平台是一款基于 Python 的 FastAPI 框架开发的实用型测试管理系统，旨在满足软件测试工作的日常需求。
    ...
    """
    APP_DESCRIPTION: str = """
    **ForkRunner（ToolBox - 测管平台）**：一款基于 Python FastAPI 的实用型测试管理系统，覆盖测试用例管理、环境配置、任务调度与报告生成的完整闭环。
